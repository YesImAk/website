...
export default function Index() {
  ...
  return (
    <>
	 ...
	 <img width="500" src="https://i.imgur.com/6EgAjw2.png" />
      </div>
        <p className="animateHeader text-white text-opacity-70 text-center mt-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            ...
            <a href="#" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
              <i className="fab fa-discord mr-2" />Support Ended
            </a>
          </div>
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
		  ...
		  <p className="text-md text-white font-medium text-gray-500 line-clamp-5">Invite chill bots to your server today!</p>
                </div>
