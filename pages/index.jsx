...
export default function Index() {
  ...
  return (
    <>
	 ...
	 <img width="250" src="/img/logo2.png" />
      </div>
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  <img src="https://cdn.discordapp.com/attachments/1116188178336985089/1118923760196653126/image.png"  width="256" className="lg:hidden rounded-xl mb-5 shadow-xl shadow-black" />
                ...
                <img src="https://cdn.discordapp.com/attachments/1116188178336985089/1118923760196653126/image.png" className="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black" />
              </>
